...
<section class="grid row">
    <form class="depth-0 offset-3 col-6" action="index.php?page=Mantenimientos_Usuarios_Formulario&mode={{mode}}&id={{id}}" method="POST">
        ...
        <div class="row align-center">
            ...
            <div class="col-8">
                <input type="text" name="useremail" id="useremail" value="{{useremail}}" placeholder="Correo Electrónico" {{isReadonly}} />
            </div>
        </div>
        <div class="row align-center">
            <div class="col-4">
        ...
        <div class="row align-center">
            ...
            <div class="col-8">
                <input type="text" name="userpswdest" id="userpswdest" value="{{userpswdest}}" placeholder="Estado de la Contraseña" {{isReadonly}} />
            </div>
        </div>
        <div class="row align-center">
            <div class="col-4">
            ...
            <div class="col-8">
                <input type="text" name="userpswdexp" id="userpswdexp" value="{{userpswdexp}}" placeholder="Fecha Expiración Contraseña" {{isReadonly}} />
            </div>
        </div>
        <div class="row align-center">
            <div class="col-4">
        ...
        <div class="row align-center">
            ...
            <div class="col-8">
                <input type="text" name="userpswdchg" id="userpswdchg" value="{{userpswdchg}}" placeholder="Token Cambio Contraseña" {{isReadonly}} />
            </div>
        </div>
        <div class="row align-center">
            <div class="col-4">
