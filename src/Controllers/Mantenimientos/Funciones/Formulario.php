...
const XSRF_KEY                 = "Mantenimientos_Funciones_Formulario";
...
class Formulario extends PublicController
{
    ...
    private function LoadPage(): void
    {
        ...
        if ($this->mode !== "INS" && empty($this->fncod)) {
            Site::redirectToWithMsg(FUNCIONES_LISTADO_URL, "Error al cargar formulario, Se requiere Código de la Función");
        } else {
            if ($this->mode !== "INS") {
                $this->CargarDatos();
            }
